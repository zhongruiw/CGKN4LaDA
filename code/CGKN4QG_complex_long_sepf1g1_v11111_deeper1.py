...
autoencoder = AutoEncoder(in_channels=2, out_channels=2, hidden_channels=16, depth=2).to(device)
...
for ep in range(1, epochs+1):
    ...
    if ep % 10 == 0:
        ...
        if val_loss_total < best_val_loss:
            ...
            # torch.save(checkpoint, r"../model/CGKN_L1024_complex_long_sepf1g1_resblock_deeper_stage1.pt")
            status = "✅"
        else:
            status = ""
...
# np.savez(r"../model/CGKN_L1024_complex_long_sepf1g1_resblock_deeper_stage1_loss_history.npz", **loss_history)
# """
