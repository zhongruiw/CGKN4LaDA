'''
Vanilla CNN for AE; dimz32 with low-rank g2
'''
import numpy as np
import torch
...
for ep in range(1, epochs+1):
    ...
    if ep % 10 == 0:
        ...
        if val_loss_total < best_val_loss:
            ...
            torch.save(checkpoint, r"../model/CGKN_L128_lowrankg2_stage1.pt")
            status = "✅"
        else:
            status = ""
...
np.savez(r"../model/CGKN_L128_lowrankg2_loss_history.npz", **loss_history)
# """
