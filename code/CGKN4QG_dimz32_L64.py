...
np.save(r"../data/CGKN_dimz32_L64_xy_unit_50StepPrediction_stage1.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_dimz32_L64_psi_50StepPrediction_stage1.npy", test_u2_pred.to("cpu"))
...
# torch.save(sigma_hat, "../data/CGKN_L64_resblock_dimz32_sigma_hat.pt")
...
# print('DA time (hrs):', (time.time() - t0) / 3600)
# MSE2_DA = nnF.mse_loss(test_u2[cut_point:], test_mu_pred[cut_point:])
# print("MSE2_DA:", MSE2_DA.item())
# test_u1 = test_u1.to("cpu")
# test_u2 = test_u2.to("cpu")
# np.save(r"../data/CGKN_L64_resblock_dimz32_psi_DA.npy", test_mu_pred.to("cpu"))
