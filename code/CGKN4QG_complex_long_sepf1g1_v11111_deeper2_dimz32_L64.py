...
for ep in range(1, epochs+1):
    ...
    if ep % 10 == 0:
        ...
        if val_loss_total < best_val_loss:
            ...
            torch.save(checkpoint, r"../model/CGKN_resblock_dimz32_L64_stage1.pt")
            status = "✅"
        else:
            status = ""
...
np.savez(r"../model/CGKN_resblock_dimz32_L64_stage1_loss_history.npz", **loss_history)
# """
...
np.save(r"../data/CGKN_resblock_dimz32_L64_xy_unit_OneStepPrediction_stage1.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_resblock_dimz32_L64_psi_OneStepPrediction_stage1.npy", test_u2_pred.to("cpu"))
