...
# torch.save(train_mu_pred, "../data/CGKN_L32_train_mu_pred(noretrain).pt")
...
# np.save(r"../data/CGKN_L32_noretrain_xy_unit_OneStepPrediction.npy", test_u1_pred.to("cpu"))
# np.save(r"../data/CGKN_L32_noretrain_psi_OneStepPrediction.npy", test_u2_pred.to("cpu"))
...
test_u1 = test_u1.to("cpu")
test_u2 = test_u2.to("cpu")
np.save(r"../data/CGKN_L32_noretrain_psi_DA.npy", test_mu_pred.to("cpu"))
...
# np.save(r"../data/CGKN_L32_noretrain_psi_DA_std.npy", test_mu_std_pred)