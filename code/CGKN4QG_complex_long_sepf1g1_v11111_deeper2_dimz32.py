...
# torch.save(sigma_hat, "../data/CGKN_resblock_dimz32_sigma_hat.pt")
...
test_u1 = test_u1.to("cpu")
test_u2 = test_u2.to("cpu")
np.save(r"../data/CGKN_resblock_dimz32_psi_DA.npy", test_mu_pred.to("cpu"))
...
np.save(r"../data/CGKN_resblock_dimz32_psi_DA_std.npy", test_mu_std_pred)