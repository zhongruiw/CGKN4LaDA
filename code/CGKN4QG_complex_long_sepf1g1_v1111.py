'''
UNet + ResBlock for AE (Deep res block)
'''
...
class ResBlock(nn.Module):
    def __init__(self, in_ch, out_ch, groups=2, drop_path=0.0, res_scale=1.0):
        ...
        self.norm3 = nn.GroupNorm(num_groups=groups, num_channels=out_ch)
        self.act3  = nn.SiLU()
        self.conv3 = CircularConv2d(out_ch, out_ch, 3, 1, 1, bias=True)
